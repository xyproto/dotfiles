;;; color-theme-borland-theme.el --- Blue/yellow theme based on old DOS Borland/Turbo C IDE

;; Copyright (C) 2015 Alexey Veretennikov

;; Author: Alexey Veretennikov <alexey dot veretennikov at gmail dot com>
;; Keywords: themes
;; URL: http://github.com/fourier/color-theme-borland-theme
;; Version: 0.1
...
;;
;;   (load-theme 'color-theme-borland t)
;;
;; Requirements: Emacs 24.

;;; Code:

(deftheme color-theme-borland
...
(provide-theme 'color-theme-borland)
;;; color-theme-borland.el ends here
